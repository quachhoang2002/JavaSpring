...
public class VNPayService {
    public static Response createOrder(int total, String orderInfor, String urlReturn){
        ...
        vnp_Params.put("vnp_CurrCode", Config.Concurency);
        ...
        response.hashID = vnp_SecureHash;
